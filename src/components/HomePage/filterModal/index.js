...
const FilterModal = (props) => {
  ...
  const [userSongs, setUserSongs] = useState(false)
  ...
  const handleNewFilter = () => {
    setURLQuery(genre, orderBy, selectedOrderBy.userSongs)
  }
      ...
      <ModalBody>
        ...
        <ModalElement>
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={selectedOrderBy.userSongs}
                style={{ color: "#116dee" }}
